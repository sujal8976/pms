...
export const generateRefreshToken = async (adminId: string) => {
  const refreshToken = jwt.sign({ adminId }, REFRESH_TOKEN_SECRET, {
...
export const deleteAllAdminRefreshTokens = async (
  adminId: string
): Promise<void> => {
